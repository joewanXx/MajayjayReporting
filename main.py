...
mock_reports = [
    {'id': 'R-1702588800000-1', 'reporter': 'Anonymous', 'title': 'Illegal Dumping Site', 'category': 'sanitation', 'location': 'Back alley behind the basketball court', 'description': 'Large piles of household trash and debris have accumulated over the past week.', 'status': 'New', 'date': '2025-10-13', 'response': None, 'proof': None},
    ...
    {'id': 'R-1702588800000-4', 'reporter': 'Mark D.', 'title': 'Broken Water Pipe', 'category': 'infrastructure', 'location': 'In front of 123 P. Gomez Street', 'description': 'Water is leaking severely, causing flooding on the street. Needs urgent attention.', 'status': 'New', 'date': '2025-10-14', 'response': None, 'proof': None},
]
